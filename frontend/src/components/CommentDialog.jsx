               ...
               <div className="py-1 flex flex-col">
                  <div className="flex items-center justify-center pr-1">
                     ...
                     {/*<Dialog>
                        ...
                        <DialogContent>
                           <Button className="text-white">Unfollow</Button>
                           <Button className="text-white">Add to favorites</Button>
                           <Button className="text-white bg-red-700 hover:bg-red-900">Delete</Button>
                        </DialogContent>
                     </Dialog>*/}
                  </div>
